...
COPY public.payments (id, payment_id, amount, currency, payment_method, created_at, token, isadmin) FROM stdin;
1	app	100	USD	credit_card	2024-10-17 13:27:27.352422	app	t
\.
